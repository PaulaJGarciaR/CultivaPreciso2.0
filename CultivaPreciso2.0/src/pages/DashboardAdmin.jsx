    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-4">
          <span className="text-white/40 text-sm">
            Hola,{" "}
            <span className="text-white/70 font-semibold">{user?.email}</span>
          </span>
          <button
      ...
      <main className="flex-1 p-8">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex gap-3">
            ...
            <div
              ...
              style={{
                background: "rgba(204,150,51,0.08)",
                border: "1px solid rgba(204,150,51,0.15)",
              }}
            >
        ...
        >
          {/* Cabecera */}
          <div
            className="grid grid-cols-[1fr_1fr_2fr_120px_100px] gap-4 px-5 py-3 text-xs uppercase tracking-widest text-white/25"
            style={{
